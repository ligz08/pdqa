# The Slack log handling classes (SlackHandler, SlackFormatter, SlackLogFilter) 
# are adapted from Junhwi Kim's python-slack-logger repository
# Original repository URL: https://github.com/junhwi/python-slack-logger
